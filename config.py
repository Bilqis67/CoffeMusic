...
BOT_NAME = getenv("BOT_NAME", "𝐂𝐨𝐟𝐟𝐞𝐞𝐋𝐚𝐭𝐭𝐞")
...
BOT_USERNAME = getenv("BOT_USERNAME", "Coffe_LatteBot")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "𝐀𝐬𝐬𝐢𝐬𝐭𝐚𝐧𝐜𝐞 𝐂𝐨𝐟𝐟𝐞𝐞 𝐋𝐚𝐭𝐭𝐞")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "famscoffe")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "DiaryFcl")
